        ...
        <div class="row mt-4">
            ...
            <div class="col">
                ...
                <form v-else v-on:submit.prevent="onSubmit($event)">
                    ...
                    <p v-if="isPositSelect" class="bg-info p-1 myclass">
                        Зарплата: {{ salaryPost ? salaryPost : "" }}
                    </p>
                    <div class="form-group">
